...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get("http://localhost:8085/getData").subscribe(function (res) {
...
/* harmony import */ var _components_userlogin_userlogin_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/userlogin/userlogin.component */ "./src/app/components/userlogin/userlogin.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                component: _components_userlogin_userlogin_component__WEBPACK_IMPORTED_MODULE_9__["UserloginComponent"]
            },
        ]
    },
    {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_userlogin_userlogin_component__WEBPACK_IMPORTED_MODULE_9__["UserloginComponent"]
            ],
            imports: [
...
module.exports = "<link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css\">\r\n<div style=\"margin-top: 0%;\" class=\"header\">\r\n\t\t<div>\r\n\t\t\t\t<img [src]=\"netImage\" class=\"figure-img img-fluid rounded\" alt=\"A generic square placeholder image with rounded corners in a figure.\">\r\n\t\t</div>\r\n\t</div>\r\n\t<p *ngIf=\"isValidFormSubmitted\" [ngClass] = \"'success'\">\r\n\t\t\tForm submitted successfully.\r\n\t\t</p>\r\n<div id=\"bg\" style=\"margin-top: 15%;position: absolute;\">\r\n <!-- <form (submit)=\"loginUser($event)\"> -->\r\n<form id = \"formNewUser\" name=\"formNewUser\" #userData = \"ngForm\" (ngSubmit) = \"addNewUser(userData.value)\">\r\n\t\t<div class=\"input\">\r\n\t\t\t\t<!-- <label>EmpCode</label> -->\r\n                <i class=\"fa fa-address-card\" style=\"font-size:36px;position: absolute;margin-top: 3%;margin-left: 86%;color: darkslategrey;\"></i>\r\n\t\t\t\t<input type=\"text\" placeholder=\"Employee Code\" id=\"userId\" name=\"userId\" ngModel>\r\n\t\t\t</div>\r\n\t<div class=\"input\">\r\n\t\t<!-- <label>Username</label> -->\r\n        <i class=\"fa fa-users\"  style=\"font-size:36px;position: absolute;margin-top:3%;margin-left: 86%;color: darkslategrey;\" aria-hidden=\"true\"></i>\r\n\t\t<input type=\"text\" placeholder=\"Username\" id=\"userName\" name=\"userName\" ngModel>\r\n\t</div>\r\n\t<div class=\"input\">\r\n\t\t<!-- <label>Password</label> -->\r\n\t\t<i class=\"fa fa-lock\"  style=\"font-size:36px;position: absolute;margin-top:2%;margin-left: 90%;color: darkslategrey;\" aria-hidden=\"true\"></i>\r\n\t\t<input type=\"password\" placeholder=\"Password\" id=\"password\" name=\"password\" ngModel \r\n\t\tpattern=\"(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{8,12}\" title=\"Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters\" required>\r\n\t</div>\r\n\t\r\n\t<div class=\"input\">\r\n\t\t\r\n\t\t<input type=\"submit\"  [disabled]=\"userData.invalid\" value=\"Login\">\r\n\t</div>\r\n</form>\r\n</div>"
...
var UserloginComponent = /** @class */ (function () {
    function UserloginComponent(router, httpService) {
        this.router = router;
        this.httpService = httpService;
        this.userNamePattern = "^[a-z0-9_-]{8,15}$";
        this.pwdPattern = "/^(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,20}$/";
        ...
        this.addNewUser = function (user) {
            ...
            this.httpService.post("http://localhost:8083/login/login", this.userObj).subscribe(function (res) {
    ...
    UserloginComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./userlogin.component.html */ "./src/app/components/userlogin/userlogin.component.html"),
            styles: [__webpack_require__(/*! ./userlogin.component.css */ "./src/app/components/userlogin/userlogin.component.css")]
        }),
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.deleteUserDetails = function (empCode) {
        return this._http.delete("http://localhost:8085/deleteUserDetails?empCode=" + empCode, this.options);
    };
    UserService.prototype.SaveUserDetails = function (user) {
        return this._http.post("http://localhost:8085/SaveUserDetails", JSON.stringify(user), this.options);
    };
    UserService.prototype.updateUserDetails = function (user) {
        return this._http.put("http://localhost:8085/updateUserDetails?empCode=" + user.empCode, JSON.stringify(user), this.options);
    };
